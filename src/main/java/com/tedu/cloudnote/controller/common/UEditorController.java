package com.tedu.cloudnote.controller.common;
...
public class UEditorController {
    ...
    public void ueditorConvert(@PathVariable("time") String time, @PathVariable("path") String path,
        ...
        try  {
            FileInputStream fis = new FileInputStream(DIR_NAME + PREFIX + PATH_SEPARATOR + time + PATH_SEPARATOR + path + "." + type);
